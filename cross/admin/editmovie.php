...
<div class="container">
  ...
  <div class="form-group">
    <input type="text" name="mv_name" value="<?php echo$row['mv_name'] ?>" class="form-control" placeholder="Киноны нэр" >
  </div>
  <div class="form-group">
   
    <input type="text" name="mv_m_desc" value="<?php echo$row['meta_description'] ?>" class="form-control" placeholder="Мета тайлбар" >
  </div>
    <div class="form-group">
   
    <input type="text" name="mv_m_tag" value="<?php echo$row['mv_tag'] ?>" class="form-control" placeholder="Мета таг" >
  </div>
  <div class="form-group">
   
    <input type="text" name="mv_link1" value="<?php echo$row['link1'] ?>" class="form-control" placeholder="Эхний линк" >
  </div>
  <div class="form-group">
   
    <input type="text" name="mv_link2" value="<?php echo$row['link1'] ?>" class="form-control" placeholder="Хоёр дох линк" >
  </div>
  <div class="form-group">
   
    <input type="date" name="mv_date" value="<?php echo$row['date'] ?>" class="form-control" placeholder="Он сар өдөр">
  </div>
  <div class="form-group">
   
    <input type="text" name="mv_lang" value="<?php echo$row['lang'] ?>" class="form-control" placeholder="Киноны хэл" >
  </div>
  <div class="form-group">
   
    <input type="text" name="mv_director" value="<?php echo$row['director'] ?>" class="form-control" placeholder="Зохиолч" >
  </div>
  <div class="form-group">
   
    <input type="text" name="cat_id" class="form-control" value="<?php echo$row['cat_id'] ?>" placeholder="Ангилал ID" >
  </div>
  <div class="form-group">
   
    <input type="text" name="genre_id" class="form-control" value="<?php echo$row['genre_id'] ?>" placeholder="Төрөл ID" >
  </div>
  ...
  <br>
  <div class="form-group">
   <input type="text"value="<?php echo$row['mv_des'] ?>" name="mv_desc" class="form-control" placeholder="Киноны тайлбар" rows="4" height="100px">
