...
<div class="row">
  ...
  <div class="col-sm-6">
    <div class="card bg-info" style="border: 1px solid #ccc;">
      <div class="card-body text-center">
        <h5 class="card-title">Нийт постны тоо</h5>
  ...
  <div class="col-sm-6">
    <div class="card bg-success" style="border: 1px solid #ccc;">
      <div class="card-body text-center">
        <h5 class="card-title">Нийт ангиллын тоо</h5>
        <p class="card-text"><?php 
  ...
  <div class="col-sm-6">
    <div class="card bg-secondary" style="border: 1px solid #ccc;">
      <div class="card-body text-center">
        <h5 class="card-title">Админы нийт тоо</h5>
        <p class="card-text"><?php 
  ...
  <div class="col-sm-6">
    <div class="card" style="border: 1px solid #ccc; background-color: #99ad5a;">
      <div class="card-body text-center">
        <h5 class="card-title">Нийт төрөл</h5>
        <p class="card-text"><?php 
...
<button class="btn btn btn-lg" onclick="first()" style="background-color: #8ab593; width: 190px;">Ангилал &#8681;&#8681;</button>
  </div>
  <div class="show" id="show" style="display: none;">
  	<hr>
  

  	<center><h1>Ангилал</h1></center>
  	<div class="row">
  			<?php 
  ...
  <div class="col-sm-6">
    ...
    <div class="card text-center">
      <div class="card-body" style="background-color: #8ab593;">
        <h5 class="card-title">Бүх постны тоо <?php echo $row1['category_name']; ?></h5>
         <?php 
      $id = $row1['id'];
      ...
      if ($run2) {
       ...
       ?>
        <a href="viewpost.php?id=<?php echo$row1['id'] ?>" class="btn btn-outline-info">Харах</a>
      </div>
    </div>
  </div>
  <?php
...
<div class="btngen text-center" id="genbtn1">
	<button class="btn btn- btn-lg" onclick="myfun1()" style="background-color: #a68e68; width: 190px;">Төрөл &#8681;&#8681;</button>
</div>
  <div class="genshow" id="genshow" style="display: none;">
  	<hr>
  	<center><h1>Төрөл</h1></center>
  	<div class="row">
  			<?php 
    ...
    <div class="card text-center">
      ...
      if ($run4) {
       while ($row4 = mysqli_fetch_assoc($run4)) {
                  ...
                  ?>
        <p class="card-text">Ангилал"<?php echo $row4['total_category']; ?>"</p>
      ...
      if ($run5) {
       while ($row5 = mysqli_fetch_assoc($run5)) {
                  ...
                  ?>
        <p class="card-text">Пост"<?php echo $row5['total_post']; ?>"</p>
