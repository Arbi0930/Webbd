...
include 'ft.php';
 ...
 <?php 
  ...
  ?>
 <div class="container">
 	<CENTER><h1>хайх<?php echo $search1; ?>"</h1></CENTER>
 ...
 <table class="table table-striped">
  <thead>
    <tr>
      ...
      <th scope="col">Төрөл ID</th>
      <th scope="col">Төрлийн тоо</th>
      <th scope="col">Нийт пост</th>
...
<td><?php echo $row2['total_post']; ?></td>
 ...
 ?>
    <td><a class="btn btn-danger" href="deletegenre.php?id=<?php echo$row['id']; ?>">Устгах</a> <a class="btn btn-outline-info" href="editgenre.php?id=<?php echo$row['id']; ?>&genrename=<?php echo$row['genre_name']; ?>&catid=<?php echo$row['category_id']; ?>&genreid=<?php echo$row['genreid']; ?>">Засах</a></td>
