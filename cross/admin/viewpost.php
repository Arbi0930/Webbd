    ...
    <div class="card" style="width:200px;text-align: center;">
     ...
     <?php echo "<img height='180px' width='auto' src='../thumb/".$row2['img']."'>"; ?>
      <div class="card-body">
        ...
        <a href="viewmovie.php?id=<?php echo$row2['id']; ?>" class="btn btn-secondary">Дэлгэрэнгүй харах</a>
      <br>
      <br>
      <a href="deletemovie.php?id=<?php echo$row2['id'] ?>" class="btn btn-danger">Устгах</a>
      <a href="editmovie.php?id=<?php echo$row2['id'] ?>" class="btn btn-info ">Засах</a>
</div>
