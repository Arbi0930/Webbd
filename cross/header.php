...
<body>
  ...
  <a class="navbar-brand" href="index.php"><h1>1235127361 golomt bank</h1></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link" href="index.php">Эхлэл <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#" data-toggle="modal" data-target="#exampleModal">Холбогдох</a>
      </li>
    <li class="nav-item">
        <a class="nav-link" href="about.php">Бидний тухай</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="disclaimer.php">татгалзал</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="privacy.php">Нууцлалын бодлого</a>
      </li>
    </ul>
  </div>
</nav>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Холбогдох</h5>
      ...
      <div class="modal-body">
       <form action="valicontact.php" method="post">
       	...
       	<br>
       	<button name="csub" class="btn btn-" style="background-color: #726297;color: #fff;">Илгээх</button>
       </form>
      </div>
...
<div class="topnav" id="myTopnav">
  <a href="index.php" class="active">Ангилал</a>
...
<div class="topnav1" id="mytopnav1">
    <a href="index.php" class="active">Төрөл</a>
  <?php 
